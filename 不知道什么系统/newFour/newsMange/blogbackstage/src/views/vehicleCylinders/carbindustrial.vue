  ...
  <div>
    ...
    <el-card class="box-card" style="margin: 20px 20px 0 20px">
      ...
      <template>
        ...
        >
          ...
          <el-table-column prop="regId" label="登记证号" show-overflow-tooltip>
            <template slot-scope="socpe">
              <p style="cursor: pointer" @click="showAddUserDiaaa(socpe.row)">
                {{ socpe.row.regId }}
              </p>
            </template>
          </el-table-column>
          ...
          >
            <template slot-scope="socpe">{{
              socpe.row.cretificationDate | fmtdate
            }}</template>
          </el-table-column>
        ...
        <el-form :model="form" :rules="rules" ref="form">
          ...
          <template>
            ...
            <el-button
              ...
              size="small"
            >
              <i style="padding-right: 10px" class="el-icon-plus"></i
              >新增气瓶信息
            </el-button>
          </template>
      ...
      <el-dialog
        ...
        title="添加信息"
        top="2vh"
        :visible.sync="dialogFormVisibleAdds"
      >
        ...
        <el-form :model="editUserForm" :rules="rules" ref="editUserForm">
          ...
          <el-col :span="24">
            <el-col :span="11">
              ...
              >
                <el-input
                  v-model="editUserForm.creditCode"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
      ...
      >
        <el-form :model="forms" :rules="rulsesad" ref="forms">
          <el-col :span="24">
            <el-col :span="8">
              <el-form-item label-width="140px" label="行政省份:">
                <el-select
      ...
      <el-dialog
        ...
        top="3vh"
        title="登记表预览下载"
        :visible.sync="dengtabledialogFormVisible"
      >
        <el-form :model="dengtable" :rules="rules" ref="dengtable">
          ...
          <el-col :span="24">
            <el-col :span="11">
              ...
              >
                <el-input
                  v-model="dengtable.certification"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
            ...
            <el-col :span="11">
              ...
              >
                <el-input
                  v-model="dengtable.certificationPerson"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
        ...
        <p style="text-align: center" slot="footer" class="dialog-footer">
          <el-button @click="dengtabledialogFormVisible = false"
            >取 消</el-button
          >
          <el-button
            :loading="loadingbuts"
      ...
      <el-dialog
        ...
        top="3vh"
        title="使用标志预览下载"
        :visible.sync="dialogbiaozhiVisibleAddbb"
      >
        ...
        <p style="text-align: center" slot="footer" class="dialog-footer">
          <el-button @click="dialogbiaozhiVisibleAddbb = false"
            >取 消</el-button
          >
          <el-button
          ...
          >
          <el-button type="primary" @click="ncftpgetss()"
            >下载pdf文档</el-button
          >
          <!-- <el-button type="primary" @click="previewFile()">预览</el-button> -->
        </p>
...
<script>
// 气瓶信息管理
// import Message from "../vehicleCylinders/carmessage"
...
export default {
  ...
  methods: {
    ...
    async AddUser() {
      // 2.关闭对话框
      this.$refs.form.validate(async (valid) => {
        if (typeof this.form.equType === "string") {
          this.form.equType = this.form.equType;
    ...
    async AddUsers() {
      this.$refs.form.validate(async (valid) => {
        if (valid) {
          ...
          //   var unlists=[];
          let obj = {
            sbCode: this.last.sbCode, //设备代码
            gasId: this.last.gasId, //产品编号
            makeInfo: this.last.makeInfo, //制造单位
            makeData: this.last.makeData, //制造日期
            pressure: this.last.pressure, //气瓶公称压力
            volume: this.last.volume, //容积
            checkData: this.last.checkData, //检查日期
            nextCheckData: this.last.nextCheckData, //下次检查日期
            selfId: this.last.selfId, //单位内部编号
            medium: this.last.medium, //介质
          };
          this.unlist.push(obj);
          this.form.lista.push(obj);
          console.log(1212);
          console.log(this.form.lista);
