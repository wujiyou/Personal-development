  ...
  <div>
    <el-card class="box-card" style="margin: 20px 20px 0 20px">
      ...
      >
        ...
        >
          ...
          <el-col :span="24">
            ...
            <el-col :span="8">
              <el-form-item label="单位类型:" label-width="140px" prop="type">
                <el-select
                disabled
                  style="width: 100%"
                  @clear="loadUserList()"
        ...
        >
          ...
          <el-col :span="24">
            ...
            <el-col :span="8">
              ...
              >
                <el-input
                  v-model="editUserForm.personnelName"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              ...
              >
                <el-input
                  v-model="editUserForm.unitPhone"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-col :span="24">
            <el-col :span="8">
              ...
              >
                <el-input
                  v-model="editUserForm.postalCode"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
      ...
      >
        <House></House>
        <div slot="footer" class="dialog-footer">
          <el-button @click="dialogFormVisiblenewUsers = false"
            >取 消</el-button
          >
      ...
      >
        ...
        <div slot="footer" class="dialog-footer">
          <el-button @click="dialogFormVisiblenewUserapp = false"
            >取 消</el-button
          >
        </div>
      </el-dialog>
...
export default {
  ...
  methods: {
    ...
    async appUserssure(userId) {
      ...
      sessionStorage.setItem("pstype", userId.type);
    ...
    async searchUser() {
      if (this.tyPe == 1) {
        ...
        const res = await this.$http.get(
          `/unit/findPage?rows=${this.rows}&page=${this.curr}&type=6&unitName=${this.unitName}&bottleType=${this.bottleType}&licence=${this.licence}&provinceCode=${this.codes}&cityCode=${this.cityCode}&areaCode=${this.areaCode}`
        );
        console.log(res);
        this.userlist = res.data.data.list;
        this.total = res.data.data.totalCount;
    ...
    async getUserlist() {
      ...
      if (this.tyPe == 1) {
        const res = await this.$http.get(
          `/unit/findPage?rows=${this.rows}&page=${this.page}&type=6&bottleType=${this.bottleType}&unitName=${this.unitName}&licence=${this.licence}&provinceCode=${this.codes}&cityCode=${this.citys}&areaCode=${this.areas}`
        );
        console.log(res);
        this.userlist = res.data.data.list;
        this.total = res.data.data.totalCount;
        ...
        const res = await this.$http.get(
          `/unit/findPage?rows=${this.rows}&page=${this.page}&type=6&bottleType=${this.bottleType}&unitName=${this.unitName}&licence=${this.licence}&provinceCode=${this.codes}&cityCode=${this.citys}&areaCode=${this.areaCode}`
        );
        console.log(res);
        this.userlist = res.data.data.list;
        this.total = res.data.data.totalCount;
        ...
        const res = await this.$http.get(
          `/unit/findPage?rows=${this.rows}&page=${this.page}&type=6&bottleType=${this.bottleType}&unitName=${this.unitName}&licence=${this.licence}&provinceCode=${this.provinceCode}&cityCode=${this.cityCode}&areaCode=${this.areaCode}`
        );
        console.log(res);
        this.userlist = res.data.data.list;
        this.total = res.data.data.totalCount;
        ...
        const res = await this.$http.get(
          `/unit/findPage?rows=${this.rows}&page=${this.page}&type=6&bottleType=${this.bottleType}&unitName=${this.unitName}&licence=${this.licence}&provinceCode=${this.codes}&cityCode=${this.cityCode}&areaCode=${this.areaCode}`
        );
        console.log(res);
        this.userlist = res.data.data.list;
        this.total = res.data.data.totalCount;
