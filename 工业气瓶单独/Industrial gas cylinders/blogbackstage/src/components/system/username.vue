    ...
    <el-card class="box-card" style="margin:20px 20px 0 20px;">
        ...
        <el-tabs style="margin-top:15px;" v-model="activeName" type="card" @tab-click="handleClick">
          ...
          <el-tab-pane label="已禁用" name="second">
            ...
            >
              ...
              <el-table-column prop="code" label="工作证编号" show-overflow-tooltip></el-table-column>
      ...
      >
        <el-form :model="form" :rules="rules" ref="form">
          <el-col :span="24">
            <el-col :span="8">
              <el-form-item prop="vestingProvinceId" label-width="200px" label="行政省份:">
                <el-select
            ...
            <el-col :span="8">
              <el-form-item prop="cityCode" label-width="200px" label="市级区域:">
                <el-select
            ...
            <el-col :span="8">
              <el-form-item prop="areaCode" label-width="200px" label="区级:">
          ...
          <el-col :span="24">
            <el-col :span="10">
              <el-form-item label="用户名" class="red_s" label-width="200px" prop="username">
            ...
            <el-col :span="10">
              <el-form-item label="单位名称" class="red_s" label-width="200px" prop="unitId">
                <el-select
                  style=" width: 100%;"
                  filterable
                  @clear="loadUserList()"
          ...
          <el-col :span="24">
            <el-col :span="10">
              <el-form-item label="工作证编号" class="red_s" label-width="200px" prop="code">
            ...
            <el-col :span="2">&nbsp;</el-col>
            <el-col :span="10">
              <el-form-item label="姓名" class="red_s" label-width="200px" prop="name">
          ...
          <el-col :span="24">
            <el-col :span="10">
              <el-form-item label="详细地址"  label-width="200px" prop="address">
                <el-input v-model="form.address" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="2">&nbsp;</el-col>
            <el-col :span="10">
              <el-form-item label="备注" label-width="200px" prop="note">
      ...
      >
        <el-form :model="editUserForms" :rules="rules" ref="editUserForms">
          <el-col :span="24">
            <el-col :span="10">
              <el-form-item label="用户名" label-width="200px" prop="username">
                <el-input disabled v-model="editUserForms.username" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>

            <el-col :span="2">&nbsp;</el-col>
            <el-col :span="10">
              <el-form-item label="工作证编号" label-width="200px" prop="code">
          ...
          <el-col :span="24">
            <el-col :span="10">
              <el-form-item label="单位名称" label-width="200px" prop="unitId">
                <el-select
                  filterable
                  size="small"
                  style=" width: 100%;"
            ...
            <el-col :span="2">&nbsp;</el-col>
            <el-col :span="10">
              <el-form-item label="联系电话" label-width="200px" prop="phone">
          ...
          <el-col :span="24">
            <el-col :span="10">
              <el-form-item label="负责人" label-width="200px" prop="name">
            ...
            <el-col :span="10">
              <el-form-item label="详细地址"  label-width="200px" prop="address">
                <el-input v-model="editUserForms.address" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-col>
          ...
          <el-col :span="24">
            ...
            <el-col :span="2">&nbsp;</el-col>
            <el-col :span="10">
              <el-form-item hidden label="id" label-width="200px" prop="id">
                <el-input v-model="editUserForms.id" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="10">
              <el-form-item hidden label="是否禁用" label-width="200px">
