    ...
    <el-card class="box-card" style="margin: 20px 20px 0 20px">
      ...
      <template>
        ...
        >
          ...
          >
            <template slot-scope="socpe">
              <p style="cursor: pointer" @click="showEditusers(socpe.row)">
                {{ socpe.$index + 1 }}
              </p>
            </template>
          </el-table-column>
        ...
        >
          ...
          >
            <template slot-scope="socpe">
              <p style="cursor: pointer" @click="gongEdituser(socpe.row)">
                {{ socpe.$index + 1 }}
              </p>
            </template>
          </el-table-column>
        ...
        >
          ...
          >
            <template slot-scope="socpe">
              <p style="cursor: pointer" @click="yiodngEdituser(socpe.row)">
                {{ socpe.$index + 1 }}
              </p>
            </template>
          </el-table-column>
      ...
      >
        <el-form :model="form">
          ...
          <el-form-item
            label="gunId(加气枪号(1-32)："
            label-width="200px"
            prop="gunId"
          >
            <el-input v-model="form.gunId" autocomplete="off"></el-input>
            <span
              >（一个控制器对应两把枪用英文逗号隔开,不同控制器的枪号用分号隔开）</span
            >
          </el-form-item>
      ...
      >
        <el-form :model="forms">
          ...
          >
            ...
            <span
              >(一个控制器对应两把枪号隔开，不同控制器的枪号用分号隔开)</span
            >
          </el-form-item>
          ...
          <el-form-item label="手持机id" label-width="200px" prop="macId">
            ...
            <span
              >(一个手持机对应两把枪号隔开，不同控制器的枪号用分号隔开)</span
            >
          </el-form-item>
